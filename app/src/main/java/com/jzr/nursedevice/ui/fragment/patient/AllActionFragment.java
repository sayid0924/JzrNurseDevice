...
public class AllActionFragment extends BaseFragment {
    public static AllActionFragment allActionFragment;
    private  PatientInfoBean.DataBean data ;

    public static AllActionFragment newInstance(PatientInfoBean.DataBean data) {
        allActionFragment = new AllActionFragment();
        allActionFragment.data = data;
    ...
    protected void initView(Bundle bundle) {
        ...
        mFragments.add(NoActionFragment.newInstance(data,1));
        mFragments.add(EndActionFragment.newInstance(data,1));
        mFragments.add(TodayActionFragment.newInstance(data,1));
