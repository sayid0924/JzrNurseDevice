...
import com.jzr.nursedevice.utils.ColorUtils;
import com.jzr.nursedevice.utils.DensityUtils;
import com.jzr.nursedevice.view.CircularCoverView;
    ...
    private void setupViews(){
        voipManager.setupView(selfPlayer, targetPlayer, new IXHResultCallback() {
            ...
            public void success(Object data) {
                ...
                XHVoipManager.getInstance().switchCamera();
            }
