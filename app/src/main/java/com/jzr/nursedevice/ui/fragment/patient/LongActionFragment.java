...
public class LongActionFragment extends BaseFragment {


    private String[] mTitles = {"未执行", "已执行", "今日医嘱"};

    public static LongActionFragment longActionFragment;
    ...
    public static LongActionFragment newInstance(PatientInfoBean.DataBean data) {
        longActionFragment = new LongActionFragment();
        longActionFragment.data = data;
        return longActionFragment;
    }
    ...
    protected void initView(Bundle bundle) {
        ...
        mFragments.add(NoActionFragment.newInstance(data,0));
        mFragments.add(EndActionFragment.newInstance(data,0));
        mFragments.add(TodayActionFragment.newInstance(data,0));
